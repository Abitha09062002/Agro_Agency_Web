...
<div class="h">Agro Agency</div>
<div class="mbg">
	<a href="after_login.php" class="menu">Order</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="food.php" class="menu">Products</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
</script> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="logout.php" class="menu" style="color: red;">Logout</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br><br><br>
  
	<a href="notification.php" class="menu">Notification</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="sales_report.php" class="menu">Product Report</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="foodsales.php" class="menu">Product Sales</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
